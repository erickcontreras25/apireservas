...
namespace Reserva
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DBContext>(opciones => opciones.UseSqlServer("Data Source=DESKTOP-PKMVCOP;Initial Catalog=Reservas;Trusted_Connection=True"));
            services.AddDbContext<DBContext>(opciones => opciones.UseSqlServer("Server=DESKTOP-PKMVCOP;Initial Catalog=Reservas;Persist Security Info=False;User ID=sa;Password=usuario34;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"));
